...
import java.io.File;
import prov.simpledb.client.Config;
...
public class BAS {
    ...
    public void Setup() {
        ...
        File propertiesFile = new File(userHome, "params.properties");
        System.out.println("setup = " + propertiesFile.toString());
        //setup.init(PairingFactory.getPairingParameters(Config.Instanc().BASPrpertyFile()));
        setup.init(PairingFactory.getPairingParameters(propertiesFile.toString()));
